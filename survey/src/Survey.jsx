    ...
    return (
        <div>
            ...
            <p>To the left of each entry on the result page, there are two circular buttons with up and down arrows that can be used to
                ...
                After marking, entries with positive feedback are highlighted in green or highlighted with red when negative. Markings of a particular entry can be removed clicking on the cancel button <RemoveCircleOutlineIcon color="action" fontSize="small" style={{ verticalAlign: 'middle' }}/>.
